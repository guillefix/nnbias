#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Feb 20 01:55:40 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 1 --mpi=pmi2 --mem-per-cpu=220000 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./count_unique_bash 
