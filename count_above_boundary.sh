#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Sep 24 01:55:26 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 250 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./count_above_boundary -p nn_t_counts/sigmab_sweep_ -N 4000 --sigmaw 1.0 --sigmab 0.01 --bshift -1.0 --arch 7,40,1 --centered
