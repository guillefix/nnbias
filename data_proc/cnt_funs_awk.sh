#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Feb 19 00:09:43 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 1 --mpi=pmi2 --mem-per-cpu=220000 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./cnt_funs_awk cat-1325700.out
