#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Feb 20 02:23:54 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 250 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /usr/bin/pigz -k0p $(nproc) head_of_full_sample.txt
