#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Jun 26 17:17:57 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 10 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./sample_net_no_train_0hl ./ 1000 2 5
