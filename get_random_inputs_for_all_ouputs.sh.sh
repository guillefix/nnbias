#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Jul 17 14:55:00 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./get_random_inputs_for_all_ouputs.sh 
