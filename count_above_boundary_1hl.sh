#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Jul 29 18:36:59 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 250 --mpi=pmi2 --mem-per-cpu=1000 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./count_above_boundary_1hl nn_t_counts/ 40000000 5
