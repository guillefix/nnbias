#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu Feb 21 13:42:25 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THREADS=16
 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./run_dist_comp 10000000 uniform_largeweight_largebias 16
