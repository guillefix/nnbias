#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Jun 26 23:02:01 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 250 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/bias/nn_bias/bias_cpp/./count_above_perceptron_boundary perceptron_sample/ 40000000 5 5
